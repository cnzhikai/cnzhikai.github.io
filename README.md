...
I am a Ph.D. student at Integrated Devices, Electronics, and Systems (IDEAS) group in the Department of Information Technology and Electrical Engineering (D-ITET), ETH Zurich. Before, I obtained an M.Sc. in Biomedical Engineering from ETH Zurich and a B.Eng. in Microelectronics from Xi'an Jiaotong University. Additionally, I gained research experience as a visiting intern at McGill University. 

My (tentative) doctoral theis is entitled *"Mechanical Micro-Devices and Metasurfaces Co-Integrated with CMOS for Biomedical, Robotic and Optical Applications"*. In my research, I develop platforms that integrate CMOS electronics with innovative devices fabricated through CMOS-compatible processes. Additionally, I am passionate about leveraging machine learning to enhance the functionality and broaden the impact of these platforms.
...
- Highly Sensitive Multimodal CMOS Antifouling Sensor Array with Multi-Use Electrodes for Single-Cell-Level Profiling of Biophysical and Biochemical Parameters
    ...
    - 2024 IEEE Symposium on VLSI Technology and Circuits (VLSI Symposium)
...
- SNE: an energy-proportional digital accelerator for sparse event-based convolutions
    ...
    - 2022 IEEE Design, Automation & Test in Europe Conference & Exhibition (DATE)
